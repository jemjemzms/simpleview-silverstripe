 ...
 * Activity Orm
 *
 * Class for mapping Activity listings' vos to ORM data objects, and then
 ...
 */
class ActivityOrm extends AbstractOrmMapper implements MapperInterface
{
    ...
    public function write()
    {
        try {
            ...
            $this->writeStack['TOListing']->ClassName = 'TOActivity';
            ...
            $this->writeStack['TOActivity'] = new \TOActivity();
            $this->writeStack['TOActivity']->ID = $listingId;
            $this->writeStack['TOActivity']->write();
