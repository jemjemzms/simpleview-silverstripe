...
class SVListings_Accommodation extends SVListings_Handler {
      ...
      $records = $responseData['DATA'];    
        ...
        foreach($records as $item){
            ...
            if($itemRecord->exists()) {
                $itemList[] = SVListings_Format::formatAccommodationList( $itemRecord->ID, $item );
            }
       }
    ...
    {
       $insert = SQLInsert::create('"'.Config::inst()->get('Simpleview', 'class').'Accommodation"');
